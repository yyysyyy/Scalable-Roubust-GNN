...
from models.base_scalable.simple_models import Layer2GraphConvolution
...
class GCN(BaseSGModel):
    def __init__(self, r, feat_dim, hidden_dim, output_dim, dropout):
        ...
        self.base_model = Layer2GraphConvolution(feat_dim=feat_dim, hidden_dim=hidden_dim, output_dim=output_dim, dropout=dropout)